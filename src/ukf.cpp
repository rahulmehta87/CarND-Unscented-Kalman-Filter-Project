...
void UKF::ProcessMeasurement(MeasurementPackage meas_package) {
  ...
  if (!is_initialized_) {
    ...
    if (dt < 0 || dt > 100) {
      ...
      ProcessMeasurement(meas_package);
      return;
    }
...
void UKF::PredictRadarMeasurement(VectorXd* z_out, MatrixXd* S_out, MatrixXd* Zsig_out) {
  ...
  //angle normalization
  z_pred(1) = tools_.NormalizeAngle(z_pred(1));
...
void UKF::CalculateNIS(VectorXd z, VectorXd z_pred, MatrixXd S) {
